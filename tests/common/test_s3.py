...
class TestS3BucketConenctorMethods(unittest.TestCase):
    """
    ...
    def test_list_files_in_prefix_wrong_prefix(self):
        """
        Tests the files list_files_in_prefix method in case of a wrong
